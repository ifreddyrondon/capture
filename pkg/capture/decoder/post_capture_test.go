...
func TestCaptureFromPOSTCaptureOK(t *testing.T) {
	...
	tt := []struct {
		...
		{
			"get pkg.Capture from decoder.POSTCapture when point present and not defaults",
			decoder.POSTCapture{
				PostPayload: payloadDecoder.PostPayload{
					Payload: payload.Payload{
						payload.Metric{Name: "power", Value: 10.0},
		...
		{
			"get pkg.Capture from decoder.POSTCapture without point and not defaults",
			decoder.POSTCapture{
				PostPayload: payloadDecoder.PostPayload{
					Payload: payload.Payload{
						payload.Metric{Name: "power", Value: 10.0},
		...
		{
			"get pkg.Capture from decoder.POSTCapture without point and default time and tags",
			decoder.POSTCapture{
				PostPayload: payloadDecoder.PostPayload{
					Payload: payload.Payload{
						payload.Metric{Name: "power", Value: 10.0},
